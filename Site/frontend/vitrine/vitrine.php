		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
			  <div class="navbar-header">
				...
				<a class="navbar-brand" href="./vitrine.php">Vestido Ideal</a>
			  </div>
	...
	<!--	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="../imagens_site/imagens/banner/b1.jpg" class="img-fluid d-block">
				</div>
				<div class="carousel-item">
					<img src="../imagens_site/imagens/banner/b2.jpg" class="img-fluid d-block" alt="...">
				</div>
				<div class="carousel-item">
					<img src="../imagens_site/imagens/banner/b3.jpg" class="d-block img-fluid" alt="...">
				</div>
			</div>
