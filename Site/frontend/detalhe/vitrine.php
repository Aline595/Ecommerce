...
<html lang="pt-br">
    ...
    <header>
		<div id="cabecalho">
			<!--Imagem logo-->
			<div class='logo'>
				<a href="vitrine.html"><img src="../imagens_site/imagens/logo-removebg-preview.png" width=150 height=100></a>
			...
			<div class="col-lg-6">
				...
				<span class="input-group-btn">
					<a href="../Busca/pagina_de_busca.html"><button  class="btn btn-default" type="button" style="background-color: black; color: white;">OK</button></a>
				</span>
				</div>
			</div>
			...
			<div id="icones_cabecalho">
				<a href="../cadastro/login.html" id="login"><i class="fas fa-user"></i></a>
				<a href="../Cesta/cesta.html" id="carrinho"><i class="fas fa-shopping-basket"></i></a>
			</div>
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
			  <div class="navbar-header">
				...
				<a class="navbar-brand" href="./vitrine.html">Vestido Ideal</a>
			  </div>
				...
				<ul class="nav navbar-nav">
				  <li class="dropdown">
					...
					<ul class="dropdown-menu">
					  <li><a href="../pag_masculino/pag_masculino.html">Masculino</a></li>
					  <li><a href="../pag_feminino/pag_feminino.html">Feminino</a></li>
					</ul>
				  </li>
				  <li><a href="../Cesta/cesta.html">Carrinho</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
				  <li><a href="../cadastro/cadastro.html"><i class="fas fa-user"></i> Cadastro</a></li>
				  <li><a href="../cadastro/login.html"><i class="fas fa-sign-in-alt"></i> Entrar</a></li>
				</ul>
			  </div>
			</div>
		  </nav>
					...
					<div class="col-sm-6 col-md-4" >
						<div class="thumbnail" >
							...
							<div class="caption text-center">
								...
								<p><a href="#" class="btn btn-primary" role="button" onclick="botaoComprar()" id="btnComprar"> Comprar </a> </p>
							</div>
						</div>
					</div>	
				<?php } ?>
