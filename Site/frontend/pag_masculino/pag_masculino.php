...
$sql = "select * from tb_roupa where genero = 'Masculino' ";
					...
					<div class="col-sm-6 col-md-4" >
						<div class="thumbnail" >
							...
							<div class="caption text-center">
								...
								<p><a href="../cesta/cesta.php?add=cesta&id=<?php echo $req['pk_id_produto']; ?>" class="btn btn-primary" role="button" id="btnComprar"> Comprar </a> </p>
							</div>
						</div>
					</div>	
				<?php } ?>
